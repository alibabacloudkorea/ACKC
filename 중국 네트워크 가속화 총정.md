...
### 특정 다수를 대상으로 하는 서비스 중 자체 운영하는 웹사이트를 사내망을 통해 접속해야 하는 경우
9.  VPN + GA
기존에  
10. SAG + CEN
SAG는 알리바바 클라우드의 SDWAN 솔루션으로 알리바바의 글로벌 백본망을 기반으로 암호화된 레이어(VPN)를 구축하여 안정적으로 빠른 사내망 구축을 돕는 서비스입니다. 일반 VPN이 인터넷 공용망을 기반으로 하여 많은 성능 이슈를 겪는 반면, SAG는 한중간 VPN을 구성하더라도 속도나 끊김 문제 없이 안정적인 성능을 제공합니다. 
중국 내 사무실 또는 지점에  SAG CPE(HardWare)나  vCPE(서버 설치용 소프트웨어)를 설치하여 운영하거나, 사용자 단말기(모바일, PC)에 SAG app을 설치하여 
12. 
13. 
14. 
15. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3MTkwNTMxNCwtMTA5MzQ0NjI2OCwzOD
g4NTU0NjMsLTE2NDQ0NzI0ODMsLTEyODc5NDE2MjIsMjA5MDE2
NDc4LC0xNjEyNzc4NjksLTEwMjgzMjkyMDEsLTgzMDA5NzcxMy
w4MTkyOTI1ODUsLTE0MDQ3NDAxNTcsMTEwNjM2OTMzLDk4ODYx
MTI5MCwtODQ1NTIyNzQ0LDE3MjA3MDM1NjcsMTkyOTYyOTUwNC
w0NDU3NDQ4MjQsLTgwNDA3MTM1NiwtMTk5NTI3NzU4OSwtMTk5
MzM1MDA0M119
-->