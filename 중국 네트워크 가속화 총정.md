...
ICP 비안이 등록된 도메인의 경우에 한하여, 서버가 중국 외 지역에 위치할 경우 CDN의 global(중국+중국외 edge노드 포함) 노드, 서버가 중국 안에 위치할 경우 CDN의 mainland China(중국 내 edge) 노드를 사용하여 컨텐츠를 가속화할 수 있습니다.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzY0NDIxMDMsLTE5OTMzNTAwNDMsLT
...
MTM3Njg3NDUwMSw2ODY5NTIwMjQsLTEyMzk4NzMyMDMsLTE0ND
Y2MjIwMDFdfQ==
-->