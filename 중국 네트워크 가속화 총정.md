...
웹사이트의 url만 Chinafy 팀에게 전달해주면 Chinafy팀은 중국 용 웹사이트를 제작하여 성능 테스트를 진행하고, 고객이 채택할 경우, DNS 변경(Chinafy 에서 제공해주는 cname으로 dns record 벼, 또는 고객 DNS의 지역기반 라우팅 기능을 사용해도 됨)
- 고려사항:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyMzc3MjUyOCwxNzIwNzAzNTY3LDE5Mj
