...
웹사이트의 url만 Chinafy 팀에게 전달해주면 Chinafy팀은 기존 사이트를 기반으로 웹 사이트와 웹 애플리케이션을 중국에 맞게 재 설계하여 성능 테스트를 진행합니다. 고객이 채택할 경우, DNS 레코드 변경(Chinafy 에서 제공해주는 cname으로 dns record 변경, 또는 고객이 사용하는 DNS의 지역기반 라우팅 기능을 사용해도 됨)을 통해 기존 사이트와 통합합니다. 

Chinafy는 중국에서 더 빠르고 호환 가능한 웹 성능을 달성하기 위해 웹 사이트와 웹 애플리케이션을 모두 재 설계하고 안전하게 재 설계하는 SaaS 기반 플랫폼입니다.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NTcwNDAwMywtMTQwNDc0MDE1NywxMT
A2MzY5MzMsOTg4NjExMjkwLC04NDU1MjI3NDQsMTcyMDcwMzU2
NywxOTI5NjI5NTA0LDQ0NTc0NDgyNCwtODA0MDcxMzU2LC0xOT
k1Mjc3NTg5LC0xOTkzMzUwMDQzLC0xMzA0MzEyNDQ0LDE1ODUz
NzgwMzksLTU2MDU0MDkyMCwtMTY4MjgyMTE0Niw0NzIwMzU1Mz
YsLTE3Njc5MjE0NjEsMTY0Nzg1MTg4NywtMTAzNzg4MTMyNSwx
ODgyNTExNjAyXX0=
-->