...
3. GA + CDN
- 소개: 위의 두가지 서비스를 합쳐 각 서비스의 한계를 보완할 수 있습니다. 중국 내 CDN edge node를 사용하여 컨텐츠를 캐싱하고, 오리진 서버와의 통신이 필요한 경우(cache update, dynamic request 등)는 GA를 통해 가속화하여, 전 구간을 가속화합니다. 
- 고려사항: 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyMDk0MzAwNiwtMTk5NTI3NzU4OSwtMT
