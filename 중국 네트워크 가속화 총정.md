...
기존에  
10. SAG + CEN
SAG는 알리바바 클라우드의 SDWAN 솔루션으로 일반 VPN이 인터넷 공용망을 기반으로 하여 성능 이슈 알리바바의 글로벌 백본망을 기반으로 암호화된 레이어를 구축하여 사용자에게 안정적으로 빠른 사내망 
12. 
13. 
14. 
15. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzUwNzQwNTE3LC0xMDkzNDQ2MjY4LDM4OD
