...
소개:
사용자 PC나 모바일 단말기의 OS나 브라우저에 pac을 설정하여 웹사이트 도메인에 대한 라우팅 경로를 임의로 바꿔주는 설정입니다. 웹사이트의 도메인이 NON-ICP 도메인이기 떄문에 
다이어그램:
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDk5NzI5MTUsMTc0MTUwNDA2LC0zMT
M3OTMxOTksLTE1NTIxMjE2Myw0MjQ3MzYyODcsLTEzMTE4NzUy
MTRdfQ==
-->