...
- 소개: 이 경우는 MS office 365, MS teams, Salesforce, Google drive, Dropbox 처럼 사내 직원들 간 협업과 업무를 위해 사용되는 SaaS 애플리케이션을 가속화는 경우입니다. 
- 다이어그램:
...
-->
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTg0OTgxODUsNDI0MTY1Nzc0LDk3Mj
