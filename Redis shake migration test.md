...
테스트 차 Target instance type을 User-Created Database Connected Over Express Connect ---" 로 해보았으나 연결은 되지 않았다. 수 차례 테스트 결과 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1MTkxOTM0OSw4NTQ0ODgzMywtNTYzOT
g1MjA2XX0=
-->