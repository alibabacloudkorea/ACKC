...
Quite interested in their user-friendly console UI. was easy to understand due to similarity with traditional CI/CD pipeline concept. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIyNzc0OTUzNCwtODUxMDExMjE5LC03NT
