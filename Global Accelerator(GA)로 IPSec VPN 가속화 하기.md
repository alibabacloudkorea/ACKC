...
## 2. Solution Overview
### 2.1 Overview
이번 가이드에서는 중국 Alibaba Cloud의 VPN Gateway와 한국 AWS의 Virtual Private Gateway를 GA와 연동합니다. 이는 테스트를 위한 차선책으로 굳이 알리바바 클라우드의 VPN Gateway를 사용하지 않더라도 아래 조건에 맞는 고객사 VPN 장비라면 GA와 연동하여 가속화할 수 있습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNDUzNTYzMywtMjEwODY1NTM3OF19
-->