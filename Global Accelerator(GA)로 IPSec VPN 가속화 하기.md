...
Endpoint Group 등록 시 Backend Service에는 한국 VPN 장비의 Public IP(Serial IP)를 등록합니다. 이번 테스트에서 사용된 AWS VPN의 경우는 Customer Gateway를 등록하고 Site-to-Site VPN connection을 생성해야 tunnel IP(VPN Public IP)가 나오기에 이번 단계에서는 임시 public IP를 등록하고 후속 단계를 거친 뒤 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTc2NDc3OTcsMTc5OTUwMzkzNSwtMT
