...
4. Proxy server: As a forward proxy and SNAT, it has two different functions to forward the traffic. it acts as a L4 proxy  helped from the upper layer to extract the domain name and also 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDAwMDA0ODIsOTczODU0Mzc3LC04NT
kyNzc4NTZdfQ==
-->